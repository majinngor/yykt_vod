...
public class MessageServiceImpl implements MessageService {
    ...
    private String aboutUs(Map<String, String> param) {
        return this.text(param, "现开设Java、HTML5前端+全栈、大数据、全链路UI/UE设计、人工智能、大数据运维+Python自动化、Android+HTML5混合开发等多门课程；同时，通过视频分享、在线课堂、大厂学苑直播课堂等多种方式，满足了全国编程爱好者对多样化学习场景的需求，已经为行业输送了大量IT技术人才。").toString();
    }
    ...
    private String subscribe(Map<String, String> param) {
        //处理业务
        return this.text(param, "感谢关注，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
    ...
    private String search(Map<String, String> param) {
        ...
        if(CollectionUtils.isEmpty(courseList)) {
            ...
            articles.append("<Url><![CDATA[http://117.72.17.55:8080/#/liveInfo/"+course.getId()+"]]></Url>");
            articles.append("</item>");
    ...
    public void pushPayMessage(Long orderId) {
        String openid = "oXlei6nsSLxE_Ds-I4XAY2hmEBWw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("7zO9EHIcu6L18K_FvGczahMCKtpA-EIWGzDLZqZqtWw")//模板id
                .url("http://117.72.17.55:8080/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
